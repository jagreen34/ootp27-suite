...
def positional_bars(league_df):
    ...
    ⚠ This previously used an inline weighted sum, which after A57 no longer
    matched score_batter (no -25 offset, no POWER curve). Bars came out ~70
    while scores came out ~13-84, making vsBar meaningless. Never recompute a
    score inline -- always call the scorer.
    """
